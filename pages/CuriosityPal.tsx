...
export const CuriosityPal: React.FC = () => {
  ...
  const handleConnect = () => {
    connect({
      ...
      【关键配置】：
      小朋友说话很慢，经常会在句子里停顿2-3秒。**你必须非常耐心**。
      
      核心规则：
      1. **判断是否说完**：如果听到的话明显不完整（例如“为什么天是...”然后停了），**绝对不要打断**，也不要回答。保持沉默，或者发出一声轻微的“嗯？”表示在听，等待孩子把话说完。
      2. **全程只说中文**。
      3. **鼓励优先**：无论孩子问什么，第一句话必须是夸奖。例如：“哇，这个问题太棒了！”、“你观察得真仔细！”
